...
date: 2018-04-26 11:20:12
categories: Docker系列
tags: [docker容器管理,docker容器状态,docker镜像管理,docker网络管理,docker容器卷管理,docker数据备份及恢复]
description: docker常用命令详解。
---
...
![docker网络模型](/assets/img/docker-bridge-module.png)

总结一下bridge网络就是：docker会在机器上自己维护一个网络，并通过`docker0`这个虚拟交换机和主机本身的网络连接在一起
